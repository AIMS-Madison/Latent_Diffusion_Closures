...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train P-CDM for Missing Physics.")
    parser.add_argument("--train-data", type=Path, default=TRAIN_DATA)
    parser.add_argument("--output", type=Path, default=PCDM_CHECKPOINT)
...
def main() -> None:
    ...
    model = build_score_model(PHYSICAL_SCORE_CONFIG, marginal_std, device)
    ...
    print(f"Saved P-CDM checkpoint to {output}")
