...
convection_AE.load_state_dict(torch.load('C:\\UWMadisonResearch\\Joint_LDM\\PretrainAE\\AE_6416_nonlinear_reg_sto_v2.pth'))

vorticity_AE = VariationalAutoEncoder().to(device)
vorticity_AE.load_state_dict(torch.load('C:\\UWMadisonResearch\\Joint_LDM\\PretrainAE\\AE_6416_vorticity_reg_sto_v2.pth'))
#
## File to store the encoded outputs.
# filename = r'C:\UWMadisonResearch\Joint_LDM\Data\train_diffusion_nonlinear_encoded_sto_v2.h5'
# batch_size = 1000
# total_samples = 18000
#
...
#
# # File to store the encoded outputs.
# filename = r'C:\UWMadisonResearch\Joint_LDM\Data\test_diffusion_nonlinear_encoded_sto_v2.h5'
# batch_size = 1000
# total_samples = 2000
#
# # Determine the shape of one encoded sample.
